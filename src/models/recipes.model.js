import Appliance from "./appliances.model.js";
import Ingredient from "./ingredients.model.js";
import Ustensile from "./ustensils.model.js";
        ...
        <figcaption class="card-body">
            <h3 class="card-title">${this.name}</h3>
                ...
                <div class="ingredients">
                    ${this.ingredients.map(ingredient => ingredient.generateIngredientsCard()).join('')}
                </div>
